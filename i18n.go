...
var english = trans{
	"average-tx": "average",
	// a month on its own ("may 2026"), which Russian declines differently from one
	// following a day ("14 may"): "май 2026" against "14 мая"
	"jan-alone": "jan",
	"feb-alone": "feb",
	"mar-alone": "mar",
	"apr-alone": "apr",
...
var langTrans = map[string]trans{
	...
	"ru": {
		...
		"none (confirms in ~10-20 min)":       "нет (подтвердится через ~10-20 мин)",
		"%d (block #%d)":                      "%d (блок %d)",
		...
		"Fees":             "Комиссии",
		"none (coinbase only)": "нет (присутствует только coinbase)",
		"lowest":               "минимальная",
		"average":              "средняя",
		...
		"this does not look like a Bitcoin address": "не Bitcoin-адрес",
		"1d":  "1д",
		"1w":  "1н",
		"1mo": "1мес",
		"3mo": "3мес",
		"1y":  "1г",
		"5y":  "5л",
		// the Mini App's miner chart
		"last 30 days": "за 30 дней",
		"last 13 weeks": "за 13 недель",
